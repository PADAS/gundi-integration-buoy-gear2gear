...
async def test_process_event_integration_created_from_pubsub(
    ...
    integration_created_event_as_pubsub_message,
    api_client,
):

    mocker.patch(
        "app.services.config_events_consumer.config_manager", mock_config_manager
    )
...
async def test_process_event_integration_updated_from_pubsub(
    ...
    mock_config_manager,
    pubsub_message_request_headers,
    integration_updated_event_as_pubsub_message,
    api_client,
):
...
async def test_process_event_integration_deleted_from_pubsub(
    ...
    mock_config_manager,
    pubsub_message_request_headers,
    integration_deleted_event_as_pubsub_message,
    api_client,
):
...
async def test_process_event_action_config_created_from_pubsub(
    ...
    mock_config_manager,
    pubsub_message_request_headers,
    action_config_created_event_as_pubsub_message,
    api_client,
):
...
async def test_process_event_action_config_updated_from_pubsub(
    ...
    mock_config_manager,
    pubsub_message_request_headers,
    action_config_updated_event_as_pubsub_message,
    api_client,
):
...
async def test_process_event_action_config_deleted_from_pubsub(
    ...
    mock_config_manager,
    pubsub_message_request_headers,
    action_config_deleted_event_as_pubsub_message,
    api_client,
):
